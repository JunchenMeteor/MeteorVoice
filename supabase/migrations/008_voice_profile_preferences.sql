...
values
  ...
  ('xunfei:x4_enus_catherine_profnews', 'xunfei', 'x4_enus_catherine_profnews', 'Catherine Professional News', 'Catherine 新闻女声', 'News-style coach voice.', '新闻风格教练声音。', 'en', 'american', 'American', 'US', 'female', 'professional news', 'featured', 'active', '2026-06-08T16:00:00.000Z', 200),
  ('xunfei:x4_enus_ryan_assist', 'xunfei', 'x4_enus_ryan_assist', 'Ryan Assistant', 'Ryan 助手男声', 'Assistant-style coach voice.', '助手风格教练声音。', 'en', 'american', 'American', 'US', 'male', 'assistant', 'featured', 'active', '2026-06-08T16:00:00.000Z', 210),
